...
const initializeUIElements = () => {
    ...
    UIElements.pagePopular = document.getElementById('page-popular');
    ...
    UIElements.mobileNavPopular = document.getElementById('mobile-nav-popular');
    ...
    UIElements.tabPopular = document.getElementById('tab-popular');
    ...
    UIElements.recommendedChannelsAddBtn = document.getElementById('recommended-channels-add-btn');
    UIElements.recommendedChannelsList = document.getElementById('recommended-channels-list');
    UIElements.recommendedChannelsEmpty = document.getElementById('recommended-channels-empty');
    UIElements.popularRecommendedSection = document.getElementById('popular-recommended-section');
    UIElements.popularRecommendedGrid = document.getElementById('popular-recommended-grid');
    UIElements.popularRecommendedEmpty = document.getElementById('popular-recommended-empty');
    UIElements.popularActiveSection = document.getElementById('popular-active-section');
    UIElements.popularActiveGrid = document.getElementById('popular-active-grid');
    UIElements.popularActiveEmpty = document.getElementById('popular-active-empty');
